...
--Create the assembly
CREATE ASSEMBLY [SqlRegEx] FROM 'C:\Documents and Settings\sabraham\Desktop\SqlRegEx\SqlRegEx\bin\Debug\SqlRegEx.dll' WITH PERMISSION_SET = SAFE
GO
...
SELECT dbo.ufn_RegExReplace('Hello World', 'h', 'J', 1)		--Ignores Case

...
copy old_phpgw_addressbook_alternate from '/var/lib/pgsql/old_phpgw_addressbook_alternate';
...
update_sequence ('global_codes','id_codes', 'seq_global_codes');
update_sequence ('phpgw_accounts','account_id', 'seq_phpgw_accounts');
update_sequence ('phpgw_addressbook','id', 'seq_phpgw_addressbook');
update_sequence ('phpgw_addressbook_accounts','id_addressbook_accounts', 'seq_phpgw_account');
update_sequence ('phpgw_addressbook_alternate','id_addressbook_alternate', 'seq_phpgw_addressbook_alternate');
update_sequence ('phpgw_addressbook_extra_history','id_history', 'seq_phpgw_addressbook_extra_history');
update_sequence ('phpgw_addressbook_favorite','id_addressbook_favorite', 'seq_phpgw_addressbook_favorite');
update_sequence ('phpgw_addressbook_field','id_addressbook_field', 'seq_phpgw_addressbook_field');
update_sequence ('phpgw_addressbook_financial','id_addressbook_financial', 'seq_phpgw_addressbook_financial');
update_sequence ('phpgw_addressbook_group','id_group', 'seq_phpgw_addressbook_group');
update_sequence ('phpgw_addressbook_group_arg','id_arg', 'seq_phpgw_addressbook_group_arg');
update_sequence ('phpgw_addressbook_history','id_history', 'seq_phpgw_addressbook_history');
update_sequence ('phpgw_addressbook_photo','id_photo', 'seq_phpgw_addressbook_photo');
update_sequence ('phpgw_addressbook_specialday','id_addressbook_specialday', 'seq_phpgw_addressbook_specialday');
update_sequence ('phpgw_applications','app_id', 'seq_phpgw_applications');
update_sequence ('phpgw_bookmarks','bm_id', 'seq_phpgw_bookmarks');
update_sequence ('phpgw_cal','cal_id', 'seq_phpgw_cal');
update_sequence ('phpgw_cal_holidays','hol_id', 'seq_phpgw_cal_holidays');
update_sequence ('phpgw_camp_sess','campuserid', 'seq_phpgw_camp_sess');
update_sequence ('phpgw_campaign','id_campaign', 'seq_phpgw_campaign');
update_sequence ('phpgw_campaign_approval','id_campaign_approval', 'seq_phpgw_campaign_approval');
update_sequence ('phpgw_campaign_client_tasks','id_campaign_client_task', 'seq_phpgw_campaign_client_tasks');
update_sequence ('phpgw_campaign_clients','id_campaign_client', 'seq_phpgw_campaign_clients');
update_sequence ('phpgw_campaign_doc_mgmt','id_campaign_doc_mgmt', 'seq_phpgw_campaign_doc_mgmt');
update_sequence ('phpgw_campaign_master','id_campaign_master', 'seq_phpgw_campaign_master');
update_sequence ('phpgw_campaign_master_docs','id_campaign_doc', 'seq_phpgw_campaign_master_docs');
update_sequence ('phpgw_campaign_tasks','id_campaign_task', 'seq_phpgw_campaign_tasks');
update_sequence ('phpgw_categories','cat_id', 'seq_phpgw_categories');
update_sequence ('phpgw_custom_fields','id_custom_fields', 'seq_phpgw_custom_fields');
update_sequence ('phpgw_custom_tabs','id_custom_tab', 'seq_phpgw_custom_tabs');
update_sequence ('phpgw_docworker_docs','id_doc', 'seq_phpgw_docworker_docs');
update_sequence ('phpgw_email_tracker','id_tracker', 'seq_phpgw_email_tracker');
update_sequence ('phpgw_emailadmin','provileid', 'seq_phpgw_emailadmin');
update_sequence ('phpgw_history_log','history_id', 'seq_phpgw_history_log');
update_sequence ('phpgw_hobbies','id_hobbies', 'seq_phpgw_hobbies');
update_sequence ('phpgw_hooks','hook_id', 'seq_phpgw_hooks');
update_sequence ('phpgw_infolog','info_id', 'seq_phpgw_infolog_id');
update_sequence ('phpgw_infolog_history','info_history_id', 'seq_phpgw_infolog_history');
update_sequence ('phpgw_links','link_id', 'seq_phpgw_links');
update_sequence ('phpgw_postoffice_addr_assoc','addr_assoc_seq', 'seq_phpgw_postoffice_addr_assoc');
update_sequence ('phpgw_postoffice_cache','cache_seq', 'seq_phpgw_postoffice_cache');
update_sequence ('phpgw_postoffice_outofoffice','id_outofoffice', 'seq_phpgw_postoffice_outofoffice');
update_sequence ('phpgw_relation','id_relation', 'seq_phpgw_relation');
